...
public class run_simulation extends StarMacro {
  ...
  private void execute0() {
    ...
    Map<Integer, Double> map = new HashMap<Integer, Double>();
      // map.put(20, 3.33e-3 * 2);
      // map.put(40, 3.33e-3 * 2);
      // map.put(80, 3.33e-3 * 2);
      map.put(160, 3.33e-3 * 2);

    Map<Integer, Double> pressure = new HashMap<Integer, Double>();
      pressure.put(300, -1.06e-5);
      ...
      for (Map.Entry<Integer, Double> p_entry : pressure.entrySet()) {
        ...
        for (Map.Entry<String, String> turb : turbulence_model.entrySet()) {
          ...
          PlotUpdate plotUpdate_0 = 
            ...
            residualPlot_0.export(resolvePath(String.format("Outputs/%s/Re%s/residuals/residuals_%s.csv", model_name, String.valueOf(Re), String.valueOf(grid))), ",");
          ...
          xyzInternalTable_0.export(resolvePath(String.format("Outputs/%s/Re%s/data/data_%s.csv", model_name, String.valueOf(Re), String.valueOf(grid))), ",");
          ...
          monitorPlot_0.export(resolvePath(String.format("Outputs/%s/Re%s/mfr/mfr_plot_%s.csv", model_name, String.valueOf(Re), String.valueOf(grid))), ",");
          Solution solution_0 = 
  ...
  private void execute1() {
    ...
    Map<Integer, Double> map = new HashMap<Integer, Double>();
      // map.put(20, 8.33e-4 * 2);
      // map.put(40, 8.33e-4 * 2);
      // map.put(80, 8.33e-4 * 2);
      map.put(160, 8.33e-4 * 2);

    Map<Integer, Double> pressure = new HashMap<Integer, Double>();
      pressure.put(1200, -1.67e-4);
  ...
  private void execute2() {
    ...
    Map<Integer, Double> map = new HashMap<Integer, Double>();
      // map.put(20, 2.11e-4 * 2);
      // map.put(40, 2.11e-4 * 2);
      // map.put(80, 2.11e-4 * 2);
      map.put(160, 2.11e-4 * 2);

    Map<Double, Double> pressure = new HashMap<Double, Double>();
      pressure.put(4.74e3, -2.61e-3);
    ...
    for (Map.Entry<Integer, Double> entry : map.entrySet()) {
      ...
      for (Map.Entry<Double, Double> p_entry : pressure.entrySet()) {
        double Re = p_entry.getKey();
        double pressure_value = p_entry.getValue();
  ...
  private void execute3() {
    ...
    Map<Integer, Double> map = new HashMap<Integer, Double>();
      // map.put(20, 2.62e-5 * 2);
      map.put(40, 2.62e-5 * 2);
      map.put(80, 2.62e-5 * 2);
      map.put(160, 2.62e-5 * 2);

    Map<Double, Double> pressure = new HashMap<Double, Double>();
    pressure.put(3.82e4, -1.69e-1);
  ...
  private void execute4() {
    ...
    Map<Integer, Double> map = new HashMap<Integer, Double>();
      // map.put(20, 3.14e-6 * 2);
      map.put(40, 3.14e-6 * 2);
      map.put(80, 3.14e-6 * 2);
      map.put(160, 3.14e-6 * 2);

    Map<Double, Double> pressure = new HashMap<Double, Double>();
    pressure.put(3.18e5, -1.18e1);
